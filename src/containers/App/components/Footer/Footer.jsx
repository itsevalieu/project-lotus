        ...
        <div>
          ...
          <ul>
            ...
            <span id="connect">
              <li>
                <a href="/">
                  <img src={facebook_logo} alt="facebook-url" />
                </a>
              </li>
              <li>
                <a href="/">
                  <img src={instagram_logo} alt="instagram-url" />
                </a>
              </li>
              <li>
                <a href="/">
                  <img src={twitter_logo} alt="twitter-url" />
                </a>
              </li>
              <li>
                <a href="/">
                  <img src={pinterest_logo} alt="pinterest-url" />
                </a>
              </li>
            </span>
            <li>
